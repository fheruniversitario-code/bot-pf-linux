...
async function abrirModalAgendarChat() {
    ...
    const telefono = window.chatActivoTelefono || chatActivoJid.replace('@s.whatsapp.net', '').split('@')[0];
    let nombre = document.getElementById('chat-nombre-cliente').textContent;
    if (nombre.trim() === 'Cliente' || nombre.trim() === telefono) nombre = ''; // Si es generico, dejar vacio para que lo llene
